...
public partial class WindowPicker:Window{
 ...
 void Capture_Click(object s,RoutedEventArgs e)=>Accept();void WindowList_DoubleClick(object s,MouseButtonEventArgs e)=>Accept();void Refresh_Click(object s,RoutedEventArgs e)=>LoadWindows();void Window_KeyDown(object s,KeyEventArgs e){if(e.Key==Key.Escape){DialogResult=false;Close();}}
}
